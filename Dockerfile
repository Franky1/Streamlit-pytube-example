...
# docker run -ti -p 8501:8501 --rm pytube:latest /bin/bash
# docker run -ti -p 8501:8501 --rm pytube:latest
# docker run -ti -p 8501:8501 -v ${pwd}:/app --rm pytube:latest
# docker run -ti -p 8501:8501 -v ${pwd}:/app --rm pytube:latest /bin/bash
